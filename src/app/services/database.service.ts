...
export class DatabaseService {
  ...
  getOrderUser(order){
    ...
    headers.append('Content-Type', 'application/json');
    headers.append('Authorization', 'Bearer '+this.authService.userToken);
    return this.http.post('/api/get-order-user', order, {headers : headers}).pipe(map(res=>res.json()));
  }
  ...
  getProductReport(product){
    ...
    headers.append('Content-Type', 'application/json')
    headers.append('Authorization', 'Bearer '+this.authService.userToken)
    return this.http.post('/api/product-report', product, {headers : headers}).pipe(map(res=>res.json())); 
  }
  ...
  getCompanyReport(company){
    ...
    headers.append('Content-Type', 'application/json')
    headers.append('Authorization', 'Bearer '+this.authService.userToken)
    return this.http.post('/api/company-report', company, {headers : headers}).pipe(map(res=>res.json())); 
  }
  ...
  getEmployees(){
    ...
    headers.append('Content-Type', 'application/json')
    headers.append('Authorization', 'Bearer '+this.authService.userToken)
    return this.http.get('/api/get-employees', {headers : headers}).pipe(map(res=>res.json()));
  }
  ...
  getEmployeeReport(employee){
    ...
    headers.append('Content-Type', 'application/json')
    headers.append('Authorization', 'Bearer '+this.authService.userToken)
    return this.http.post('/api/employee-report', employee, {headers : headers}).pipe(map(res=>res.json())); 
  }
